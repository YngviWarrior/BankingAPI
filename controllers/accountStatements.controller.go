...
import (
	...
	usecase "api-go/usecases/accountStatement/accountStatements"
	"encoding/json"
	"fmt"
	"log"
	"net/http"
...
func (c *Controllers) HandlerListStatement(w http.ResponseWriter, r *http.Request) {
	...
	useCaseInputDto := usecase.InputListStatementDto{Account: *input.Account, DateStart: fmt.Sprintf("%s 00:00:00", *input.DateStart), DateFinish: fmt.Sprintf("%s 23:59:59", *input.DateFinish)}
